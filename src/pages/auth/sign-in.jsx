		...
		try {
			...
			if (resultAction.meta.requestStatus === 'fulfilled') {
				...
				if (requires2FA) {
                    ...
                    setRequires2FA(true); // Show 2FA form
					setLoggingIn(false)
                } else {
	...
	return (
		<section className="m-8 flex gap-4">
			<div className="w-full lg:w-3/5 mt-24">
                ...
                labelProps={{
					className: " bg-white mx-2 px-2 peer-focus:w-[auto] peer-focus:h-[15px]  !leading-1  block w-auto before:content-none after:content-none",
                }}
              /> */}
